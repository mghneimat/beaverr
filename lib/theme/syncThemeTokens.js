 ...
 */
export function syncThemeTokens(mode, themeRefs, options = {}) {
  ...
  if (typeof document !== 'undefined') {
    ...
    if (!options.skipRootBackground) {
      setWebRootBackground(C.bg);
    }
...
/** Set html/body fill — used by palette sync. */
export function setWebRootBackground(bg) {
