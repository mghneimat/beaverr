...
/** @typedef {'goals' | 'reduceCosts'} GoalUiSection */

export const GOAL_CATEGORY_ORDER = /** @type {const} */ (['savings', 'debt', 'reduceCosts']);
export const GOAL_UI_SECTION_ORDER = /** @type {const} */ (['goals', 'reduceCosts']);
...
/**
 * Dashboard layout — savings + debt payoff in one "Goals" section.
 * @param {import('../schema').Goal[]} goals
...
export function groupGoalsForUiSections(goals) {
  ...
  return {
    goals: [...grouped.savings, ...grouped.debt],
