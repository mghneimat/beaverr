...
const VIEW_WIDTH = 605.25;
const VIEW_HEIGHT = 761.48;
const ASPECT = VIEW_HEIGHT / VIEW_WIDTH;

/** undraw_broadcast_gyxl.svg */
export default function BroadcastIllustration({ width = ONBOARDING_ILLUSTRATION.width }) {
  const { t } = useI18n();
  ...
  return (
    <Svg
      ...
      accessibilityLabel={t('onboarding.housing.housingUtilities.illustrationA11y')}
    >
    <Path
