...
const VIEW_MIN_X = 0;
const VIEW_MIN_Y = -89.68;
const VIEW_WIDTH = 794.67;
const VIEW_HEIGHT = 794.67;
const ASPECT = VIEW_HEIGHT / VIEW_WIDTH;

/** undraw_ride-a-bicycle_oozn.svg */
export default function RideABicycleIllustration({ width = ONBOARDING_ILLUSTRATION.width }) {
  const { t } = useI18n();
  ...
  return (
    <Svg
      ...
      accessibilityLabel={t('onboarding.transport.bicycle.illustrationA11y')}
    >
    <Path
