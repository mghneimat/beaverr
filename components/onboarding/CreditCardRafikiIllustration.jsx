...
/** Full 500×372 artboard — square crop clipped coins and character on both sides. */
const VIEW_MIN_X = 0;
const VIEW_MIN_Y = 0;
const VIEW_WIDTH = 500;
const VIEW_HEIGHT = 372.61;
const ASPECT = VIEW_HEIGHT / VIEW_WIDTH;
export default function CreditCardRafikiIllustration({ width = ONBOARDING_ILLUSTRATION.width }) {
  const { t } = useI18n();
  ...
  return (
    <Svg
      ...
      accessibilityLabel={t('onboarding.subscriptions.illustrationA11y')}
    >
    <G
      id="freepik--background-complete--inject-366"
    >
      <Rect
        y={327.45}
        width={500}
    ...
    <G
      id="freepik--credit-card--inject-366"
    >
      <Rect
        x={102.26}
        y={334.02}
    ...
    <G
      id="freepik--Character--inject-366"
    >
      <Path
