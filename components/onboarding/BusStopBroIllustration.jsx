...
import Svg, { Ellipse, G, Line, Path, Polygon, Polyline, Rect } from 'react-native-svg';
...
/** Bus Stop-bro.svg */
export default function BusStopBroIllustration({ width = ONBOARDING_ILLUSTRATION.width }) {
  const { t } = useI18n();
  ...
  return (
    ...
    <G
      id="freepik--Shadow--inject-1--inject-68"
    >
      <Ellipse
        cx={259.33}
        cy={383.43}
    ...
    >
      ...
      />
      <Polygon
        points="365.81 327.53 148.56 327.53 161.6 320.35 352.77 320.35 365.81 327.53"
        fill="#2e353a"
      />
      <Rect
        x={134.57}
      ...
      />
      <Polygon
        points="98.57 393.06 95.39 395.67 95.39 183.12 98.57 183.12 98.57 393.06"
        fill="#2e353a"
      />
      <Polygon
        points="104.24 194.51 89.73 194.51 89.73 127.24 104.24 131.15 104.24 194.51"
        fill="#2e353a"
      />
      <Polygon
        points="102.83 187.96 91.14 187.96 91.14 133.79 102.83 136.43 102.83 187.96"
        fill="#3B82F6"
      />
    </G>
    <G
      id="freepik--Character--inject-1--inject-68"
    >
      <Path
        d="M172.74,258.36s0-5,0-5,0,5,0,5Z"
        fill="#2e353a"
      />
      <Path
        d="M287,252.35a7.52,7.52,0,0,1,3.9,5.87c.54,4.33,9.79,33.3,9.79,35.47s-4.41,5.45-8.21,5.45-6.32-13.37-6.32-13.37Z"
        fill="#fff"
      />
      <Polyline
        points="289.17 263.15 286.59 270.03 290.89 266.59"
        fill="none"
      />
      <Path
        d="M237.29,252.3s-4.6,2.11-5.32,6.09S224,296.07,224.4,297.7s10.66,4.33,12.28,3.61S239,282.52,239,282.52Z"
        fill="#fff"
      />
      <Line
        x1={238.63}
      ...
      />
      <Path
        d="M253.82,246.12s-15.82,5-16.53,6.18,3.65,46,3.65,48.87,1.13,5.09,5.38,6.36,23.63,1,28.3.57,9.76-3.68,10.19-6.65,2.27-46.39,2.69-48.47c.18-.92-3.46-2.41-7.2-3.91-3.23-1.29-11.06-4.64-14-4.64S259.34,243.58,253.82,246.12Z"
        fill="#fff"
      />
      <Path
        d="M264,295a18.92,18.92,0,0,0-.65,3.87c0,1.51,3.44,1.08,3.44,3.23s-3.87,4.08-3.87,4.08"
        fill="none"
      />
      <Path
        d="M252.36,295.76s4.5,5.31,20,2.66"
        fill="none"
      />
      <Path
        d="M256.65,242.87s-3.68,1-4.39,2.4.43,3.4.57,5-2,7.64-2,7.64,4.24-.14,5,.42,7.92,5.52,7.92,5.52,2.41-5.94,5.24-6.79,5.38-1.7,5.38-1.7-3.4-4.81-4.53-8.63S261.46,240.18,256.65,242.87Z"
        fill="#2e353a"
      />
      <Path
        d="M255.09,240.18s2.55,11.18,2.69,18-4.1,21.79-2.12,26,7.36,8.49,7.78,8.49,4.39-7.36,4.67-12.6-3.82-18.82-2.55-24.76a97.83,97.83,0,0,0,1.56-14.15Z"
        fill="#fff"
      />
      <Path
        d="M255.09,240.18s.53,2.33,1.12,5.51a13,13,0,0,0,7.06,1.73,8.94,8.94,0,0,0,3.51-.93c.26-3,.34-5.32.34-5.32Z"
        fill="#3B82F6"
        opacity={0.54}
      />
      <Path
        d="M263.44,292.68c.43,0,4.39-7.36,4.67-12.6s-3.82-18.82-2.55-24.76q.19-.91.36-1.89a14.06,14.06,0,0,1-2.86.36,13,13,0,0,1-5.73-1.1,53.88,53.88,0,0,1,.45,5.46c.14,6.79-4.1,21.79-2.12,26S263,292.68,263.44,292.68Z"
        fill="#fff"
      />
      <Path
        d="M289.52,295.41s26.2,18.81,26.41,20.92-11.83,15.43-16.27,15S280,304.71,280,304.71Z"
        fill="#3B82F6"
      />
      <Polygon
        points="244.61 249.45 286.01 303.12 289.08 296.07 250.4 247.3 244.61 249.45"
        fill="#3B82F6"
      />
      <Path
        d="M234.33,368.53l.37,8s-5.79,4-8.32,5.6-6.86,4.15-5.42,5.24,21,0,21,0,.54-.36.54-2.71-.36-12.83-.36-12.83Z"
        fill="#fff"
      />
      <Path
        d="M242.46,384.61c0-.66,0-2-.07-3.51l-5.89.44s0-.73-.18-2.9-1.62-2.16-1.62-2.16-5.79,4-8.32,5.6-6.86,4.15-5.42,5.24,21,0,21,0S242.46,387,242.46,384.61Z"
        fill="#2e353a"
      />
      <Path
        d="M220.87,386.23c-.26.43-.28.81.09,1.09,1.45,1.08,21,0,21,0s.26-.19.42-1.09Z"
        fill="#fff"
      />
      <Path
        d="M285.83,368.53l-.36,8s5.78,4,8.31,5.6,6.86,4.15,5.42,5.24-21,0-21,0-.54-.36-.54-2.71.36-12.83.36-12.83Z"
        fill="#fff"
      />
      <Path
        d="M277.7,384.61c0-.66,0-2,.07-3.51l5.89.44s0-.73.18-2.9,1.63-2.16,1.63-2.16,5.78,4,8.31,5.6,6.86,4.15,5.42,5.24-21,0-21,0S277.7,387,277.7,384.61Z"
        fill="#2e353a"
      />
      <Path
        d="M299.29,386.23c.27.43.28.81-.09,1.09-1.45,1.08-21,0-21,0s-.26-.19-.42-1.09Z"
        fill="#fff"
      />
      <Path
        d="M242.28,304.93s-12.1,3.79-16.44,6.86-2,9.58,2.53,13.73,11.2,6.87,16.08,4.7,10.3-7.05,17.53-7.05,13.55,5.61,20,7.95,15-5.24,16.63-11.56-2.44-13.38-12.47-12.65C264.93,308.46,260.47,310,242.28,304.93Z"
        fill="#2e353a"
      />
      <Path
        d="M229.64,312.15s-6.15-1.8-7.95,4,3.07,38.66,4,45,.72,7.41.72,7.41,7.77,1.26,10.3,2.71,6.51,1.44,6.51,1.44-3.62-23.49-2.89-28.91,3.61-9.21,2.89-14.81-5.6-13-5.6-13"
        fill="#2e353a"
      />
      <Path
        d="M290.79,312.15s6.14-1.8,7.95,4-3.08,38.66-4,45-.72,7.41-.72,7.41-7.77,1.26-10.3,2.71-6.51,1.44-6.51,1.44,3.62-23.49,2.9-28.91-3.62-9.21-2.9-14.81,5.61-13,5.61-13"
        fill="#2e353a"
      />
      <Path
        d="M282.38,317.19a56.79,56.79,0,0,0-5,10.69,15.67,15.67,0,0,1,2.58-9.67"
        fill="none"
      />
      <Path
        d="M286.38,312.83a9.06,9.06,0,0,0-2.08,1.81"
        fill="none"
      />
      <Path
        d="M236.91,316.27s6,7.74,6.24,13.33"
        fill="none"
      />
      <Path
        d="M240.78,317.78c1.08,2.58,1.08,4.73,2.37,9.67"
        fill="none"
      />
      <Line
        x1={232.16}
      ...
      />
      <Path
        d="M245.05,218l2.68,11.6s-3.11-2-3.11.85,1.28,4.38,3,5a6.15,6.15,0,0,0,3.26.14,14.48,14.48,0,0,0,3.39,4.53,13.31,13.31,0,0,0,9.2,3.39c3.25,0,7.5-3.25,8.63-7.07s-2.55-11-3.11-15.85,4.1-4.67,2-8.63-13.44-4.67-20.38-3S245.05,218,245.05,218Z"
        fill="#fff"
      />
      <Path
        d="M267.54,222.35a2.42,2.42,0,0,0-1.84,3.26,6.37,6.37,0,0,0,2.27,3.82s.71,2.12-2.55,1.84"
        fill="none"
      />
      <Path
        d="M261.57,223.37a4.59,4.59,0,0,0-5.13,1.62"
        fill="none"
      />
      <Path
        d="M261.59,227.45c.13.61,0,1.16-.38,1.24s-.73-.35-.87-1,0-1.17.37-1.25S261.45,226.84,261.59,227.45Z"
        fill="#2e353a"
      />
      <Path
        d="M268.09,226c.14.61,0,1.17-.37,1.25s-.73-.36-.87-1,0-1.16.37-1.24S268,225.42,268.09,226Z"
        fill="#2e353a"
      />
      <Line
        x1={267.26}
      ...
      />
      <Polygon
        points="250.05 305.83 252.58 308.72 248.61 311.79 246.26 309.8 250.05 305.83"
        fill="#2e353a"
      />
      <Path
        d="M233.43,291.37s1.08-.54,3.61,1.09S251.5,304,250.6,306.19a6.72,6.72,0,0,1-5.43,4c-2.52.36-13.91-6.69-17-8.68s-4-2.89-3.79-3.79-.18-3.43,2-4.52"
        fill="#fff"
      />
      <Polygon
        points="273.18 304.38 269.75 307.09 273.36 311.07 276.43 308.36 273.18 304.38"
        fill="#2e353a"
      />
      <Path
        d="M291.79,289.93s-4.15,1.08-6.14,2.89a94,94,0,0,1-7.89,5.84c-1.63,1.18-3.77,2.15-5,3.84-1.62,2.31.1,3.6,1.77,5.26,4.05,4,8.95.52,12.77-1.75s8.08-4.42,11.32-7.41c2.35-2.17,2.89-5.78.18-8"
        fill="#fff"
      />
      <Path
        d="M252.58,308.72a17.13,17.13,0,0,1,4.52,2.53c1.26,1.26,3.43,7.95,3.43,9.4s.18,2.89-.9,2.89-1.81-.91-2.35-.91-2.53-1.26-4.34-2.35-3.07-4.51-3.61-6.14-.72-2.35-.72-2.35Z"
        fill="#fff"
      />
      <Line
        x1={256.08}
      ...
      />
      <Path
        d="M269.75,307.09a53.65,53.65,0,0,0-4.52,3.62c-1.26,1.26-3.43,8-3.43,9.39s-.18,2.89.9,2.89,1.81-.9,2.35-.9,2.53-1.26,4.34-2.35,3.07-4.52,3.61-6.14a5.48,5.48,0,0,0,.36-2.53Z"
        fill="#fff"
      />
      <Line
        x1={262.7}
      ...
      />
      <Path
        d="M270.94,211.88c-2.12-4-13.44-4.67-20.38-3s-5.51,9.06-5.51,9.06l2.55,11,.7.87s1,.85,1.42-.14-1.42-3.54-.71-4.53,3.54,0,2.69-3.39-.85-5.52,3.11-6.94,8.77-2,10.89-.42,3.26,6.08,3.26,6.08C268.39,215.7,273.06,215.84,270.94,211.88Z"
        fill="#2e353a"
      />
      <Path
        d="M246.07,217.19a11.94,11.94,0,0,0,3.74,0c2-.33,2.45-4.43,9.19-5.4s6.7,2.64,6.7,2.64,3.68-3.73,2.16-4.91-12.3-.91-16.86,2.91"
        fill="none"
      />
      <Path
        d="M311.28,319.15A14,14,0,0,1,310,320.5"
        fill="none"
      />
      <Path
        d="M300.83,306.39s12.06,8.18,11.86,10a3.06,3.06,0,0,1-.25.89"
        fill="none"
      />
    </G>
    </Svg>
