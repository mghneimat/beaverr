/**
 * Beaverr coach chat system prompt (v2).
 * Human-editable source of truth: docs/gemini-system-prompt-beaverr-chat.md
 * Keep in sync with lib/advice/beaverrChatSystemPrompt.js
 */
export const BEAVERR_CHAT_SYSTEM_PROMPT = `# BEAVERR FINANCIAL COACH — CHAT MODE
